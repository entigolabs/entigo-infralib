...
const (
	...
	RabbitMQUserName    = "test-rabbitmq-user"
	RabbitMQUserKind    = "rabbitmqusers.mq.entigo.com"
	RabbitMQAwsUserKind = "user.mq.aws.m.upbound.io"

	RabbitMQUserSpecName              = "appuser"
	RabbitMQUserCredentialsSecretName = RabbitMQUserName + "-credentials"
	RabbitMQUserBrokerProtectionName  = RabbitMQUserName + "-broker-protection"
