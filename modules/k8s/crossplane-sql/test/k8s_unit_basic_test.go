...
func TestK8sCrossplaneSQLBiz(t *testing.T) {
	testK8sCrossplaneSQL(t, "arn:aws:eks:eu-north-1:877483565445:cluster/biz-infra-eks", "biz")
}

func TestK8sCrossplaneSQLPri(t *testing.T) {
	testK8sCrossplaneSQL(t, "arn:aws:eks:eu-north-1:877483565445:cluster/pri-infra-eks", "pri")
}

func testK8sCrossplaneSQL(t *testing.T, contextName string, envName string) {
	t.Parallel()

	namespaceName := "crossplane-system"
	releaseName := "contrib-provider-sql"
