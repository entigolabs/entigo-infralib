...
func TestK8sHarborAWSBiz(t *testing.T) {
	testK8sHarbor(t, "arn:aws:eks:eu-north-1:877483565445:cluster/runner-main-biz", "biz", "k8s_unit_basic_test_aws_biz.yaml")
}

func TestK8sHarborAWSPri(t *testing.T) {
	testK8sHarbor(t, "arn:aws:eks:eu-north-1:877483565445:cluster/runner-main-pri", "pri", "k8s_unit_basic_test_aws_pri.yaml")
}

func testK8sHarbor(t *testing.T, contextName, envName, valuesFile string) {
	t.Parallel()
	spew.Dump("")
	...
	namespaceName := "aws-karpenter"
	extraArgs := make(map[string][]string)
	setValues := make(map[string]string)

	if prefix != "runner-main" {
		namespaceName = fmt.Sprintf("aws-karpenter-%s", prefix)
	...
	// err = terrak8s.WaitUntilDeploymentAvailableE(t, kubectlOptions, "karpenter-deployment", 30, 10*time.Second)
	// if err != nil {
