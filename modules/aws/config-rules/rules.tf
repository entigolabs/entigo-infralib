...
resource "aws_config_conformance_pack" "operational_best_practices_for_cis_aws_v1_4_level2" {
  name  = "${var.prefix}-operational-best-practices-for-cis-aws-v1-4-level2"
  count = var.operational_best_practices_for_cis_aws_v1_4_level2_enabled ? 1 : 0
