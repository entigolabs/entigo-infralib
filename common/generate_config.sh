...
export ENTIGO_INFRALIB_IMAGE="entigolabs/entigo-infralib-testing:v1.11.6-rc96"
...
main_k8s_conf() {
  generate_config_k8s "./modules/k8s" "apps" "argocd" "aws-alb" "aws-storageclass" "cluster-autoscaler" "crossplane-aws" "crossplane-core" "crossplane-google" "external-dns" "external-secrets" "google-gateway" "istio-base" "istio-istiod" "loki" "metrics-server"
}
